...
#define I2C_KILLCOUNTER_THRESHOLD 1000

//////////////
uint16_t i2c_killCounter = 0; //Wird in Schleifen hochgezählt, bricht ggf. ab, wenn etwas zu lange dauert
uint8_t i2c_killCounterCheck = 0;
