...
#define GROUNDSENS_CNT_TH_CHECKPOINT 15 //More than n times below the Threshold of a checkpoint (IS checkpoint!)
#define GROUNDSENS_CNT_TH_BLACKTILE 22 //More than n times below the Threshold of a black tile
#define RAMP_CNT_ISRAMP 30 //More than n times above the Threshold of ramp (up and down)
